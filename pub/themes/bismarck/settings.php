<?
  ...
  $settings['display']['default_skin']='avalanche';
  ...
  $settings['display']['max_char_length']=20;
  ...
  $settings['display']['playerstats_guid_length']=16;
  ...
  $settings['display']['gamestats_killchart']=20;
  ...
  $settings['display']['gamestats_killchart_per_weapon']=0;
